...
function ExplorerContent() {
    ...
    // ✅ CORRECTION TS7053 : On définit que l'objet accepte des clés de type string
    ...
    // Chargement des libellés de catégories
    useEffect(() => {
    ...
    // ✅ Utilisation sécurisée du dictionnaire
                        ...
                        {loading ? (
                            ...
                            <div className="flex flex-col items-center py-32 text-center max-w-sm mx-auto">
                                ...
                                <P className="text-gray-400 text-sm mb-8">
                                    Nous n'avons pas trouvé de prestataires dans la catégorie "{categoryLabel}".
                                </P>
                                <Button onClick={handleRemoveFilter} variant="primary" className="w-full">
